...
essential_packages=(
    aria2 bc busybox perl-mozilla-ca cjson dialog easyeffects flatpak lolcat fortune-mod p7zip packagekit pandoc httpie wsdd xclip zip font-manager zed powertop  ripgrep-all sassc screen socat sshpass nsxiv terminator thefuck thermald tumbler gufw yad
)
