...
GITHUB_REPO="git@github.com:wvpianoman/brian.everything.git"
...
#chown brian:brian ~/.ssh/config
chown brian:brian ~/.ssh/id_ed25519
chown brian:brian ~/.ssh/id_ed25519.pub
...
xdg-open https://github.com/wvpianoman/brian.everything.git
