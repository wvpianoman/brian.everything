...
sudo dnf5 install -y breeze-gtk breeze-gtk-{gtk2,gtk3,gtk4} breeze-icon-theme gnome-tweaks thunar-archive-plugin Thunar thunar-volman numlockx spectacle kitty gnome-commander spacefm soundconverter xfce4-terminal fonts-tweak-tool
