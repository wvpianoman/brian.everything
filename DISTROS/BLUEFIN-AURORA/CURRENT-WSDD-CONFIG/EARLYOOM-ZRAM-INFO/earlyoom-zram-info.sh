...
# pulled from Tokga Erok scripts @ https://github.com/tolgaerok

# Basic info

# Run from remote location:
# sudo bash -c "$(curl -fsSL https://raw.githubusercontent.com/wvpianoman/brian-everything/main/BASE/EARLYOOM-ZRAM-INFO/earlyoom-zram-info.sh)"
