...
# **ZSH / Fish Shells and Plug-Ins:**

    zsh                     - The Z Shell
    zsh-dbginfo             - Debug symbols for zsh
    zsh-autosuggestions     - Fish-like autosuggestions for zsh
    zsh-syntax-highlighting - Fish shell like syntax highlighting for ZSH
    antibody                - A fast zsh plugin manager
    powerlevel10k           - Powerlevel10k is a theme for Zsh.
    powerline               - Powerline vim plugin and shell prompts
    powerline-dbginfo       - Debug symbols for powerline
    rcm                     - RC (dot-file) management

    fish                    - A full-blown user-friendly command line shell
